...
# function or a variable named sum in your solution. You can download the sample data at http://www.py4e.com/code3/mbox-short.txt 
...
for line in fh:
    if not line.startswith("X-DSPAM-Confidence:"):
        continue
    count = count + 1
    cut = cut + float(line[line.find(':') + 1:])
spam = cut/count
